...
def viewMonth(request, month_id):
	...
	s += ('<br><a href = "' +makeString(m.day1, m=m.id) + '/">Day1</a><br>'\
			'<a href = "' +makeString(m.day2, m=m.id) + '/">Day2</a><br>'\
			'<a href = "' +makeString(m.day3, m=m.id) + '/">Day3</a><br>'\
			'<a href = "' +makeString(m.day4, m=m.id) + '/">Day4</a><br>'\
			'<a href = "' +makeString(m.day5, m=m.id) + '/">Day5</a><br>'\
			'<a href = "' +makeString(m.day6, m=m.id) + '/">Day6</a><br>'\
			'<a href = "' +makeString(m.day7, m=m.id) + '/">Day7</a><br>'\
			'<a href = "' +makeString(m.day8, m=m.id) + '/">Day8</a><br>'\
			'<a href = "' +makeString(m.day9, m=m.id) + '/">Day9</a><br>'\
			'<a href = "' +makeString(m.day10, m=m.id) + '/">Day10</a><br>'\
			'<a href = "' +makeString(m.day11, m=m.id) + '/">Day11</a><br>'\
			'<a href = "' +makeString(m.day12, m=m.id) + '/">Day12</a><br>'\
			'<a href = "' +makeString(m.day13, m=m.id) + '/">Day13</a><br>'\
			'<a href = "' +makeString(m.day14, m=m.id) + '/">Day14</a><br>'\
			'<a href = "' +makeString(m.day15, m=m.id) + '/">Day15</a><br>'\
			'<a href = "' +makeString(m.day16, m=m.id) + '/">Day16</a><br>'\
			'<a href = "' +makeString(m.day17, m=m.id) + '/">Day17</a><br>'\
			'<a href = "' +makeString(m.day18, m=m.id) + '/">Day18</a><br>'\
			'<a href = "' +makeString(m.day19, m=m.id) + '/">Day19</a><br>'\
			'<a href = "' +makeString(m.day20, m=m.id) + '/">Day20</a><br>'\
			'<a href = "' +makeString(m.day21, m=m.id) + '/">Day21</a><br>'\
			'<a href = "' +makeString(m.day22, m=m.id) + '/">Day22</a><br>'\
			'<a href = "' +makeString(m.day23, m=m.id) + '/">Day23</a><br>'\
			'<a href = "' +makeString(m.day24, m=m.id) + '/">Day24</a><br>'\
			'<a href = "' +makeString(m.day25, m=m.id) + '/">Day25</a><br>'\
			'<a href = "' +makeString(m.day26, m=m.id) + '/">Day26</a><br>'\
			'<a href = "' +makeString(m.day27, m=m.id) + '/">Day27</a><br>'\
